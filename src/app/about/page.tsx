        ...
        <div className="sn-shell sn-split" style={{ display: "grid", gridTemplateColumns: "420px 1fr", gap: 44, alignItems: "start" }}>
          <Reveal>
            <div style={{ position: "relative" }}>
              <Image src="/assets/select-network/lorenzo-bio-editorial.jpg" alt="Lorenzo Miller" width={1242} height={1780} style={{ width: "100%", height: "auto", borderRadius: 16, border: "1px solid #e7e2d8", boxShadow: "0 18px 45px rgba(5,20,45,.12)", objectFit: "cover", objectPosition: "center 18%" }} />
