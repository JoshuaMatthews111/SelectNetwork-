...
import { Binoculars, Star, TrendingUp, FolderOpen, Wallet, Network, TreePine, Megaphone, Settings, Bell, Mail, Diamond, CheckCircle, FileText, CircleDot, Menu, LogOut, MessageSquare, Award, Target, Ribbon, CalendarDays } from "lucide-react";
...
const MEMBER_ROLE: "Select Member" | "Builder" = "Builder";
// Builder = Select Member access plus referral network tools.
...
const allTabs = [
  ...
  { id: "matrix", label: "My Referral Network", ico: <TreePine size={20} />, roles: ["Select Member", "Builder"] },
          ...
          <div className="sn-desktop-topbar" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 22, gap: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, flexShrink: 0 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div className="sn-user-desktop"><b style={{ fontSize: 14 }}>Lorenzo</b> <span style={{ background: "linear-gradient(135deg,#d1a645,#bc8b25)", color: "#fff", fontSize: 9, fontWeight: 900, padding: "2px 7px", borderRadius: 4, verticalAlign: "middle" }}>Foundation Partner</span><br /><small style={{ color: "#667085" }}>Founder · Select Member-Builder</small></div>
              </div>
            </div>
          </div>
            ...
            <div className="sn-mobile-content" style={{ animation: "fadeIn .5s ease" }}>
              ...
              {showTutorial && (
                <div style={{ background: "linear-gradient(135deg,#071a33,#0d3366)", border: "2px solid #bd8e28", borderRadius: 16, padding: "24px 28px", marginBottom: 22, position: "relative" }}>
                  ...
                  <p style={{ color: "#c6d2e1", fontSize: 12.5, margin: "0 0 16px" }}>You have full select member access plus referral network tools. Here&apos;s a quick guide:</p>
                ...
                <div>
                  <div id="cert-display" style={{ background: "#fff", border: "3px solid #bd8e28", borderRadius: 16, padding: "48px 56px", maxWidth: 820, margin: "0 auto", boxShadow: "0 20px 60px rgba(5,20,45,.12)", position: "relative", overflow: "hidden" }}>
                    ...
                    <div style={{ textAlign: "center" }}>
                      <div style={{ marginBottom: 20 }}><Image src="/assets/select-network/select-network-logo.png" alt="The Select Network Member Group" width={280} height={70} style={{ width: 240, height: "auto", margin: "0 auto", display: "block" }} /></div>
